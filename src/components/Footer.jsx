function Footer() {
  return (
    <div
      ...
      className=" z-10 w-full h-[104 vh] rounded-t-3xl bg-zinc-100 text-[#212121] px-20 pt-32 pb-20 flex"
    >
      <div className="w-1/2 flex flex-col justify-between">
        <div className="w-full text-[8vw] leading-none font-semibold ">
          <h1 className="  uppercase font-['Founders_Grotesk_X'] -mb-10">
            eye-
          </h1>
          <h1 className="uppercase font-['Founders_Grotesk_X']">opening</h1>
        </div>
      ...
      <div className="w-1/2">
        <div className="w-full">
          <h1 className="text-[8vw] leading-none font-semibold font-['Founders_Grotesk_X']  uppercase">
            presentations
          </h1>
          <div className="w-full flex justify-between text-xl">
            <div className="w-2/3">
              <div className="socialLinks  mb-10">
                <h3 className="mb-5">S:</h3>
                <a className="block capitalize" href="#">
                  instagram
                </a>
                <a className="block capitalize" href="#">
                  behance
              ...
              <div className="email  mb-10">
                ...
                <a className="block " href="#">
                  sjkatwa2000@gmail.com
                </a>
              </div>
              <div className="email  mb-10">
                <h3 className="mb-5 text-zinc-300">
                  © ochi design 2024. Legal Terms
                </h3>
              </div>
            </div>
            <div className="w-1/3 mt-20 flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-zinc-300">Website by Obys</h3>
              </div>
            </div>
          </div>
        </div>
